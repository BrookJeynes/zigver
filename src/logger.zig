...
const Logger = struct {
    ...
    stdout: BufferedFileWriter = BufferedFileWriter{ .unbuffered_writer = std.io.getStdOut().writer() },
    stderr: BufferedFileWriter = BufferedFileWriter{ .unbuffered_writer = std.io.getStdErr().writer() },
